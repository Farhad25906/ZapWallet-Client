        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-20">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 max-w-7xl mx-auto">
            {transactionFees.map((item, index) => (
              ...
              >
                <Card
                  className="border-2 hover:border-[#009689] h-full transition-all duration-300 hover:shadow-xl group"
                >
                  <CardContent className="p-6 md:p-8 text-center">
                    <div className={`${item.color} w-14 h-14 md:w-16 md:h-16 rounded-xl flex items-center justify-center mx-auto mb-4 md:mb-6 group-hover:rotate-12 transition-transform`}>
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-20">
          ...
          <div className="grid sm:grid-cols-2 gap-6 max-w-6xl mx-auto">
            {additionalInfo.map((item, index) => (
              ...
              >
                <Card
                  className="border-2 hover:border-[#ffd8af] h-full transition-all duration-300 bg-white"
                >
